        ...
        <div class="container">
          <div class="row">
            <div class="col-4 auto">
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    <td>Address</td>
                    <td>1-2-3, ○○ Ward, Tokyo 123-4567, Japan</td>
                  </tr>
                  <tr>
                    <td>Phone Number</td>
                    <td>012-345-6789</td>
            ...
            <div class="col-4 auto">
              ...
              <button class="btn btn-primary">You can also use our inquiry form.</button>
            </div>
            <div class="col-4 auto">
              <h6>SNS:</h6>
          ...
          <p class="text-primary">&copy; 2023 BANTO STOCK. All Rights Reserved.</p>
