        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#"><i class="fi fi-sr-edit" style="margin-right: 5px;"></i>Edite item</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#"><i class="fi fi-sr-ballot" style="margin-right: 5px;"></i>Transaction</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#"><i class="fi fi-sr-exit" style="margin-right: 5px;"></i>log out</a>
              </li>
            </ul>
          </div>
        </div>
